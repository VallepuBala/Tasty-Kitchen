...
const logoUrl =
  'https://res.cloudinary.com/dbwo9v78q/image/upload/v1724071187/logo_ahe7u3.png'
  ...
  render() {
    ...
    return (
      <div className="login-route-main-bg-container">
        <img
          src="https://res.cloudinary.com/dbwo9v78q/image/upload/v1724068948/cld-sample-4.jpg"
          alt="website login"
